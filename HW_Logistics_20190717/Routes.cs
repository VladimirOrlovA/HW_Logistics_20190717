...
namespace HW_Logistics_20190717
{
    class Routes
    {
        ...
        public void addRoute(Route addRoute)
        {
            ...
            routesList[routesList.Length - 1] = addRoute;
        }
        ...
        public void InsertTable(IConnDataBaseSQL obj)
        {
            ...
            sb.Append("INSERT INTO Routes (routeID, routeStart, routeEnd, carrierRoutesID) VALUES ");
            ...
            {
                count++;
                sb.Append($"('{i.routeID}', '{i.routeStart}', '{i.routeEnd}') ");
        ...
        public void CreateTable(IConnDataBaseSQL obj)
        {
            ...
            sb.Append(" carrierRoutesID INT DEFAULT NULL ");
            sb.Append("); ");
